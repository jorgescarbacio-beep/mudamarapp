...
function HannaPage({ tarifas, saveTarifas }) {
  ...
  const clientName = "Hanna";
  const clientKey = "hanna";
  const tarifaKey = "hannaTarifaViaje";

  useEffect(() => {
    // Tarifa por defecto para Hanna
    const defaultTarifas = { [tarifaKey]: 90000 };
